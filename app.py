...
try:
    train = pd.read_csv("https://drive.google.com/uc?export=download&id=1kyosU7eRhEJV-uqONy0BFEr-Y5ZO5UA2", delimiter=",", quotechar='"', encoding='utf-8')
...
def home():
    ...
    if request.method == 'POST':
        if 'tweet' in request.form:
            ...
            print(f"Tweet: {tweet}, Prediction: {pred[0]}, Probabilities: {pred_proba}")
